...
function displayPage(page) {
    ...
    display.innerHTML += page.Title;
    display.innerHTML += page.Image;
    display.innerHTML += page.Description;
}

function aboutMeClicked() {
    let display = document.getElementById("display");
    display.innerHTML = null;
    display.innerHTML += `<h2>About Me</h2>`;
    display.innerHTML += `<img src=\"media/Images/me.jpg\" alt=\"Me\">`;
    display.innerHTML += `<p>I am a programmer who loves everything about the video game creation process. I love the music, mechanics, art, and story of games. To me, being passionate is the most important part about developing games. When working with others, I have learned that developing a strong relationship among group members allows for this passion to grow. Therefore, I believe that a game designer must be open-minded and passionate about everything they do. I have experience designing and developing multiple different genres of games. During my time at RIT, my coding experience and my experience working with game engines and frameworks have been refined. I am someone who is organized, goal-oriented, and self-critical. Additionally, I am an effective problem solver who applies his math skills to facets such as game balance. My favorite types of games are competetive games. I love fighting games, MOBAs, and RPGs. Having the ability to express myself in games is one of my driving forces for playing games.</p>`;
}
