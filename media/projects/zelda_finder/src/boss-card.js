...
class BossCard extends HTMLElement{
    constructor(){
        super();
    ...
    static get observedAttributes(){
        ...
        return ["data-name","data-description","data-likes"];
    }
...
customElements.define('boss-card', BossCard)