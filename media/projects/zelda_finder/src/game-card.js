...
class GameCard extends HTMLElement{
    constructor(){
        ...
        this.developer = this.shadowRoot.querySelector("#developer");
        this.release = this.shadowRoot.querySelector("#release-date");
    ...
    static get observedAttributes(){
        ...
        return ["data-name","data-developer","data-released_date","data-description","data-likes"];
    }
    ...
    render(){
        ...
        const developer = this.getAttribute('data-developer') ? this.getAttribute('data-developer') : "<i>...developer...</i>";
        const release = this.getAttribute('data-released_date') ? this.getAttribute('data-released_date') : "<i>...release date...</i>";
        ...
        this.developer.innerHTML = `Developer: ${developer}`;
        this.release.innerHTML = `Release Date: ${release}`;
